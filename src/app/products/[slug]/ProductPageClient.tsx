...
export default function ProductPageClient({ product: initialProduct }: ProductPageClientProps) {
  ...
  const faqItems = useMemo(() => [
    ...
    { question: "Do products come with a warranty?", answer: "New items typically include a manufacturer warranty. For second-hand items, we offer a 30-day DeelDepot Guarantee for returns and exchanges, unless otherwise stated." },
    { question: "Can I return a product if it doesn't meet my expectations?", answer: "Absolutely! Your satisfaction is our top priority. We offer a generous 30-day return window. Contact us at +17176484487 or support@DeelDepot.com and we'll work with you to make it right. Read our Return Policy for complete details." },
    ...
    { question: "How can I contact customer support?", answer: "We're here to help! Call us at +17176484487 or email support@DeelDepot.com. Business hours: Monday-Friday 9:00 AM - 5:00 PM EST, Saturday 10:00 AM - 3:00 PM EST. We respond to all inquiries promptly and are committed to resolving any issues quickly." }
  ], []);
              ...
              <div className="lg:mt-8 lg:space-y-3 fixed bottom-0 left-0 right-0 z-50 lg:relative lg:z-auto bg-white border-t border-gray-200 lg:border-0 lg:bg-transparent px-4 py-3 lg:px-0 lg:py-0 shadow-lg lg:shadow-none lg:space-y-3 space-y-2">
                {product && product.inStock === false ? (
                  ...
                  <>
                    ...
                    {(product.checkoutFlow === 'paypal-invoice' || product.checkoutFlow === 'paypal-unclaimed' || product.checkoutFlow === 'paypal-direct') ? (
