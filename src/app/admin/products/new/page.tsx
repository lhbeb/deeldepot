        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              disabled={loading || formData.collections.length === 0}
              className="inline-flex items-center gap-2 px-4 py-2 bg-[#0F1341] text-white text-sm font-medium rounded-xl hover:bg-[#1c2070] disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
              title={formData.collections.length === 0 ? 'Please select at least one collection' : ''}
            >
              {loading ? <Loader2 className="h-4 w-4 animate-spin" /> : <Save className="h-4 w-4" />}
